            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="/pdf_data_servis?status[]=Diambil" target="_blank" class="btn btn-dark">PDF</a>
                        </div>
                    </div>
                            ...
                            @foreach ($db as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{-- <a href="{{ url('/edit_dataservice', ['id' => $data->id]) }}"
                                        ...
                                        <a href="{{ route('delete-data-servis', ['id' => $data->id]) }}"
                                        ...
                                        {{-- <div class="btn-group">
                                            ...
                                            <form action="{{ route('data-service.update-status', $data->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                                <ul class="dropdown-menu" aria-labelledby="statusDropdown">
                                                    <li><button class="dropdown-item" type="submit" name="status"
                                                            value="Baru">Baru</button></li>
                                                    <li><button class="dropdown-item" type="submit" name="status"
                                                            value="Diproses">Diproses</button></li>
                                                    <li><button class="dropdown-item" type="submit" name="status"
                                                            value="Selesai">Selesai</button></li>
                                                    <li><button class="dropdown-item" type="submit" name="status"
                                                            value="Diambil">Diambil</button></li>
                                                    <li><button class="dropdown-item" type="submit" name="status"
