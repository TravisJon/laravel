            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="/pdf_data_servis?status[]=Baru" target="_blank" class="btn btn-dark">PDF</a>
                        </div>
                    </div>
                        ...
                        <tbody>
                            @foreach ($db as $data)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($data->datapelanggan->created_at)->format('d-m-Y') }}</td>
                                    ...
                                    <td>
                                        @if ($data->status == 'Baru')
                                            ...
                                            style="width: 15px">{{ $data->status }}</span> --}}
