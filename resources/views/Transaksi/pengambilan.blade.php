        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('add_pengambilan') }}" method="GET" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select name="pelanggan_id" class="form-select" aria-label="Default select example">
                                    <option selected disabled>Pilih Data Servis</option>
                    ...
                    {{-- @if (isset($dataserviceID))
                        <div class="row">
                            <div class="col-md-12">
                                <table class="table">
                                    <tr>
                                        <th>ID SERVICE</th>
                                        <td>{{ $dataserviceID->id }}</td>
                                    </tr>
                                    <tr>
                                        <th>Nama Pelanggan</th>
                                        <td>{{ $dataserviceID->datapelanggan->nama }}</td>
                                        <th>Kelengkapan</th>
                                        <td>{{ $dataserviceID->kelengkapan }}</td>
                                    </tr>
                                    <tr>
                                        <th>Jenis Barang</th>
                                        <td>{{ $dataserviceID->jenisbarang->nama }}</td>
                                        <th>Serial Number</th>
                                        <td>{{ $dataserviceID->serial_number }}</td>
                                    </tr>
                                    <tr>
                                        <th>Kerusakan</th>
                                        <td>{{ $dataserviceID->kerusakan }}</td>
                                        <th>Catatan</th>
                                        <td>{{ $dataserviceID->catatan }}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('add-barang-jasa', $dataserviceID->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="col-12 p-2">
                                    <label for="inputNama4" class="form-label fw-bold">Item Barang Jasa</label>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-responsive table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($addBarangJasa as $item)
                                        @php
                                            $total += $item->barangJasa->harga_jual;
                                        @endphp
                                        <tr>
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('dataservice.baru') }}" class="btn btn-danger"><i
                                        class="ri-arrow-left-line"></i> Back</a>
                                <a href="{{ route('data-service.service-diproses', $dataserviceID->id) }}"
